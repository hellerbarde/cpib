...
namespace Compiler
{
  public class Scanner
  {
    ...
    /// </summary>
    public Dictionary<string, Func<Token>> Keywords { get; private set; }
    ...
    public Scanner()
    {
<<<<<<< HEAD:Compiler/Compiler/Scanner/Scanner.cs
      #region keywords
      Keywords = new Dictionary<string, Func<Token>>();
...
=======
        ...
        public IList<Token> Scan(StreamReader reader)
        {
            lock (this)
            {
                ...
                return TokenList;
>>>>>>> 83e2fa2afc7da70bbf14d9d58904258dbdf2389e:Compiler/Compiler/01Scanner/Scanner.cs
            }
            CurrentState.Handle(this, '\n'); //newline char is omitted in the ReadLine method
          }
